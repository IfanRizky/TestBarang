...
public class TambahData extends AppCompatActivity {
    ...
    //variable fields EditTex dan Button
    ...
    public void submitBrg(Barang brg) {
         ...
         * ke Firebase Realtime Database dan juga kita set onSeccessListener
         * yang berisi kode yang akan dijalankan ketka data berhasil ditambahkan*/
